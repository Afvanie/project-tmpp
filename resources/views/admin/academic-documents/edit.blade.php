...
@section('title', 'Ubah Dokumen Akademik')
    ...
    <header>
        ...
        <p
            class="mt-2 max-w-3xl
                   ...
                   text-slate-500"
        >
            Perbarui informasi, file, tautan, atau status dokumen.
        </p>
    </header>
                                ...
                                @else
                                    <span
                                        class="text-xs font-semibold
                                               text-red-600"
                                    >
                                        File saat ini tidak ditemukan
                                    </span>
                                @endif
                            @endif

                            @if ($safeCurrentExternalLink)
                                <a
                ...
                >
                    ...
                    <p
                        class="mt-1 text-xs
                               leading-6 text-slate-500"
                    >
                        Kosongkan apabila file lama tidak perlu
                    diganti. Format PDF, JPG, JPEG, PNG, atau
                    WebP maksimal 20 MB.
                    </p>
