...
@section('title', 'Ubah Data Dosen atau Staf')
    ...
    <header>
        ...
        <p
            class="mt-2 max-w-3xl
                   ...
                   text-slate-500"
        >
            Perbarui nama, NIP, kategori, atau foto personel.
        </p>
    </header>
    ...
    >
        ...
        >
            ...
            <div>
                ...
                >
                    Kosongkan apabila foto tidak perlu diganti. Format JPG, JPEG, PNG, atau WebP maksimal 2 MB.
                </p>
                ...
                >
                    ...
                    >
                        <img
                            ...
                            class="{{ $currentPhotoUrl ? 'h-full w-full object-cover object-top' : 'hidden h-full w-full object-cover object-top' }}"
                        >

                        <div
                            id="photoPlaceholder"
                            class="{{ $currentPhotoUrl ? 'hidden px-5 text-center' : 'px-5 text-center' }}"
                        >
                            <div
                ...
                @if (
                    ...
                    >
                        Foto tercatat, tetapi file tidak ditemukan.
                    </p>
                @endif
